...
//Serial1.println("***************");
//    Serial1.println("print newFrame=");
//    Serial1.println("***************");
...
void myReadByte() {
 ...
 //Serial1.print("byte = ");   Serial1.println( c);
  ...
  if ( !m_frameInProgress ) { // intially or when the frame has arrived, it is considered that the frame is not in progress
    ...
    if ( c == m_startByte ) {
      ...
      //Serial1.println("start byte [pos = 0]");
...
//    Serial1.println("mpos = " ); Serial1.println(m_pos);
//      Serial1.println("=m_totalByteSize " ); Serial1.println(m_totalByteSize);
...
//      
      // the receive buffer is full
       ...
       // Serial1.println(" newFrameArrived=");
      ...
      m_pos = 0; // reset the index to the buffer
      return;
    } // the receive buffer is full
...
void printLEDBytesToSerialMonitor( byte * totalReceiveBuffer,  int totalByteSize  )
{
  ...
  for (int i = 0; i < totalByteSize; i++) {
    ...
    if ( i % 3 == 0) {
      ...
      Serial1.print("  r: ");
      Serial1.print(totalReceiveBuffer[i]);
    }
    else if ( i % 3 == 1) {
      Serial1.print("  g:  ");
      Serial1.print(totalReceiveBuffer[i]);
