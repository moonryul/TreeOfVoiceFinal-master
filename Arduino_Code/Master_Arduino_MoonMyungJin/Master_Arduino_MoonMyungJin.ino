...
// readFrameWaterCurtain();
 ...
 if (  m_newFrameHasArrived == true) {
    ...
    Serial1.println("new frame has arrived");
    
 }
 else {
     //Serial1.println("new frame has not arrived");
 }
...
void readFrameWaterCurtain() {
  ...
  for (int j = 0; j < count; ++j) {
      ...
      Serial1.println(m_receiveBuffer[j]);
...
//        
   // Serial1.print("read byte=");      Serial1.println(c);

    //Serial1.print("index=");   Serial1.println(index);
...
//
      m_newFrameHasArrived == true;
       Serial1.println("New frame arrived");
//
     index = 0;
//
   } //  // the receive buffer is full
...
//
      //if ( i % 3 == 0 ) {
     // Serial1.print("led  index=");
     //  Serial1.print( ledIndex++ );
      //}
//        
      if ( i % 3 == 0) {
         Serial1.print("led  index=");
