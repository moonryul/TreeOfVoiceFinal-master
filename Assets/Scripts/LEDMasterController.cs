        ...
        if (m_ThreadAlreadyCreated == true)
        {
            ...
            {  // is there a thread running?
              ...
              //  Debug.Log(" the previous run of the thread has finished");
               ...
               // Debug.Log(" send LED array ( 4 colors for each chain ) to arduino");
                ...
                //    int sizeOfChain1 = m_LEDColorGenController.m_firstChain;
                //    int sizeOfChain2 = m_LEDColorGenController.m_secondChain;
                //    int sizeOfChain3 = m_LEDColorGenController.m_thirdChain;
                //    int sizeOfChain4 = m_LEDColorGenController.m_fourthChain;


                //    for (int i = 0; i < sizeOfChain1; i++)
                //    {
                //        m_LEDArray[3 * i ] = 250;
                //        m_LEDArray[3 * i + 1] = 0;
                //        m_LEDArray[3 * i + 2] = 0;
                ...
                //    for (int i = 0; i < sizeOfChain2; i++)
                //    {
                //        m_LEDArray[sizeOfChain1 * 3 + 3 * i] = 0;
                //        m_LEDArray[sizeOfChain1 * 3 + 3 * i + 1] = 250;
                //        m_LEDArray[sizeOfChain1 * 3 + 3 * i + 2] = 0;

                //    }

                //    // the third chain
                //    for (int i = 0; i < sizeOfChain3; i++)
                //    {
                //        m_LEDArray[(sizeOfChain1 + sizeOfChain2) * 3 + 3 * i] = 0;
                //        m_LEDArray[(sizeOfChain1 + sizeOfChain2) * 3 + 3 * i + 1] = 0;
                //        m_LEDArray[(sizeOfChain1 + sizeOfChain2) * 3 + 3 * i + 2] = 250;

                //    }

                //    // the fourth chain
                //    for (int i = 0; i < sizeOfChain4; i++)
                //    {
                //        m_LEDArray[(sizeOfChain1 + sizeOfChain2 + sizeOfChain3) * 3 + 3 * i] = 250;
                //        m_LEDArray[(sizeOfChain1 + sizeOfChain2 + sizeOfChain3) * 3 + 3 * i + 1] = 250;
                //        m_LEDArray[(sizeOfChain1 + sizeOfChain2 + sizeOfChain3) * 3 + 3 * i + 2] = 250;
